...
do
	...
	function library.new(title)
		local container = utility:Create("ScreenGui", {
			...
			utility:Create("ImageLabel", {
				...
				Position = UDim2.new(0.154838711, 0, 0.234803334, 0),
				Size = UDim2.new(0, 465, 0, 407),
				...
				utility:Create("ImageLabel", {
					...
					Size = UDim2.new(0, 110, 1.01719904, -45),
					ZIndex = 3,
	...
	function section:addToggle(title, default, callback)
		local toggle = utility:Create("ImageButton", {
			...
			ZIndex = 2,
			Image = "rbxassetid://5028857472",
			ImageColor3 = Color3.fromRGB(29, 29, 29),
			ScaleType = Enum.ScaleType.Slice,
			SliceCenter = Rect.new(2, 2, 298, 298)
		},{
			utility:Create("TextLabel", {
	...
	function library:SelectPage(page, toggle)
		...
		if toggle then
			...
			button.Line.BackgroundColor3 = Color3.fromRGB(255,255,255)
			...
			button.Title.TextTransparency = 0
			button.Line.BackgroundColor3 = Color3.fromRGB(45, 45, 45)
