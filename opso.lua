...
local themes = {
	...
	LightContrast = Color3.fromRGB(2,24,46), 
...
do
	...
	function library.new(title, subtitle)
		local container = utility:Create("ScreenGui", {
			...
			utility:Create("ImageLabel", {
				...
				ImageColor3 = Color3.fromRGB(8, 7, 12),
	...
	function section:addButton(title, callback)
		local button = utility:Create("ImageButton", {
			...
			ZIndex = 2,
			Image = "rbxassetid://5028857472",
			ImageColor3 = Color3.fromRGB(2,24,46),
			ScaleType = Enum.ScaleType.Slice,
	...
	function section:updateToggle(toggle, title, value)
		...
		value = value and true and false
        ...
        if value == true then
            ...
            utility:Tween(frame, {
                ...
                Position = position["In"] + UDim2.new(0, 0, 0, 2.5)
            }, 0.2)
        ...
        elseif value == false then
            ...
            utility:Tween(frame, {
                Size = UDim2.new(1, -22, 1, -9),
                Position = position["Out"] + UDim2.new(0, 0, 0, 2.5)
            }, 0.2)
