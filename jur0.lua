...
local objects = {}
local themes = {
	Background = Color3.fromRGB(9, 16, 27), 
	Glow = Color3.fromRGB(0, 0, 0), 
	Accent = Color3.fromRGB(10, 10, 10), 
	LightContrast = Color3.fromRGB(11, 20, 34), 
	DarkContrast = Color3.fromRGB(9, 16, 27),  
...
do
	...
	function library.new(title, subtitle)
		local container = utility:Create("ScreenGui", {
			...
			utility:Create("ImageLabel", {
				...
				Position = UDim2.new(0.107741937, 0, 0.189511329, 0),
				Size = UDim2.new(0, 433, 0, 507),
				Image = "rbxassetid://4641149554",
				ImageColor3 = Color3.fromRGB(6, 10, 18),
				...
				utility:Create("ImageLabel", {
					...
					Size = UDim2.new(0, 120, 1.01699996, -95),
					ZIndex = 3,
					...
					utility:Create("ScrollingFrame", {
						...
						Size = UDim2.new(0.959999979, 0, 1, -20),
	...
	function page.new(library, title)
		...
		local container = utility:Create("ScrollingFrame", {
			...
			ScrollBarImageColor3 = Color3.fromRGB(9, 16, 27),
			Visible = false
		}, {
			utility:Create("UIListLayout", {
				SortOrder = Enum.SortOrder.LayoutOrder,
	...
	function section:addToggle(title, default, callback)
		local toggle = utility:Create("ImageButton", {
			...
			utility:Create("ImageLabel", {
				...
				ZIndex = 2,
				Image = "rbxassetid://5028857472",
				ImageColor3 = Color3.fromRGB(1, 7, 14),
				ScaleType = Enum.ScaleType.Slice,
				SliceCenter = Rect.new(2, 2, 298, 298)
			}, {
				utility:Create("ImageLabel", {
					...
					ZIndex = 2,
					Image = "rbxassetid://5028857472",
					ImageColor3 = Color3.fromRGB(150, 173, 183),
					ScaleType = Enum.ScaleType.Slice,
					SliceCenter = Rect.new(2, 2, 298, 298)
				})
			})
			...
			utility:Create("TextLabel", {
				...
				utility:Create("ImageLabel", {
					...
					utility:Create("ImageLabel", {
						...
						ZIndex = 3,
						Image = "rbxassetid://5028857472",
						ImageColor3 = Color3.fromRGB(7,168,251),
						ScaleType = Enum.ScaleType.Slice,
						SliceCenter = Rect.new(2, 2, 298, 298)
					}, {
						utility:Create("ImageLabel", {
	...
	function section:updateToggle(toggle, title, value)
        ...
        if value == true then
            button.ImageColor3 = Color3.fromRGB(4, 23, 46)
            frame.ImageColor3 = Color3.fromRGB(2, 170, 253)
            utility:Tween(frame, {
                Size = UDim2.new(1, -22, 1, -9),
                Position = UDim2.new(0, 20, 0.5, -6) + UDim2.new(0, 0, 0, 2.5)
            }, 0.2)
        ...
        elseif value == false then
            button.ImageColor3 = Color3.fromRGB(1, 7, 14)
            frame.ImageColor3 = Color3.fromRGB(150, 173, 183)
            utility:Tween(frame, {
                Size = UDim2.new(1, -22, 1, -9),
                Position = UDim2.new(0, 2, 0.5, -6) + UDim2.new(0, 0, 0, 2.5)
            }, 0.2)
